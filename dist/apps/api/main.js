...
const PeopleFilter = new graphql_1.GraphQLInputObjectType({
    name: 'GeoPoint',
    fields: {
        lat: { type: new graphql_1.GraphQLNonNull(graphql_1.GraphQLFloat) },
        lon: { type: new graphql_1.GraphQLNonNull(graphql_1.GraphQLFloat) },
        alt: { type: graphql_1.GraphQLFloat, defaultValue: 0 },
    },
});
